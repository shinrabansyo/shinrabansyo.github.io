...
![Tang nano 9K](/images/docs/01-02/01_TANGnano9K.gif) 
...
![これでOK](/images/docs/01-02/02_UgokebaOK.gif)  
...
![Adder.scala](/images/docs/01-02/03_Adder-scala.gif)   
...
![FlipFlop](/images/docs/01-02/05.flipflop.png)  
  
  
2. Top.scala（Adder.scalaをテストするやつ）をChiselで書く  
  
![Top.scala](/images/docs/01-02/04_Top-scala.gif)  
...
![sbt test（あってるとき）](/images/docs/01-02/02_UgokebaOK.gif)  
250 + 10 = 「4」を「2」にしてみるとこんな感じ。ちゃんと「違う！！」って言ってくれます。  
![sbt test（違うとき）](/images/docs/01-02/06_TestNG.gif)  
