...
![ゴール](/images/docs/01-01/01_goal.gif)
...
![おすすめディレクトリ構成](/images/docs/01-01/02_recommendedDirectory.gif)    
...
![拡張機能](/images/docs/01-01/03_Extensions.gif)  
...
![sbtの公式サイト](/images/docs/01-01/v2-01_sbtOfficial.png) 
...
![環境変数の編集](/images/docs/01-01/v2-02_hennsuu1.png)  
...
![JDK導入1](/images/docs/01-01/04_JavaExtension1.gif)  
![JDK導入2](/images/docs/01-01/05_JavaExtension2.gif)  
...
![JavaVersion確認](/images/docs/01-01/06_CheckJavaVersion.gif)
...
sbt test
```  
![SBTtest](/images/docs/01-01/07_SBTtest.gif)
```
[info] MainTest:
...
sbt run
```  
![SBTrun](/images/docs/01-01/08_SBTrun.gif)
```
[info] running Main
Hello, World!
```  
